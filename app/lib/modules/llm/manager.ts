...
export class LLMManager {
  ...
  async updateModelList(options: {
    ...
    // Preserve provider-defined order (OpenRouter curated list stays on top).
  ...
  async getModelListFromProvider(
    ...
    // Preserve provider order (curated OpenRouter models stay pinned at top)
  ...
  getDefaultProvider(): BaseProvider {
    // Prefer OpenRouter as the default provider for Chinna-DIY
