...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'cloud-providers': 'Configure OpenRouter (the AI provider for Chinna-DIY)',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  // Local providers hidden — Chinna-DIY is OpenRouter-only in the UI
