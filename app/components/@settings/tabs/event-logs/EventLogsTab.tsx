...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Chinna-DIY
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('Chinna-DIY - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Chinna-DIY', margin, doc.internal.pageSize.getHeight() - 10);
